...
# ------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    infoboxmap = Map(
        ...
        polygons=[{
            ...
            'stroke_weight': 3,
            'path': c_raw,
            'infobox': 'Calculated Spread of Closest Fire after 1 week'
        },{
            ...
            'stroke_weight': 3,
            'path': s_raw,
            'infobox': 'Calculated Spread of Second Closest Fire after 1 week'
        },{
            ...
            'stroke_weight': 3,
            'path': t_raw,
            'infobox': 'Calculated Spread of Third Closest Fire after 1 week'
        }],
        circles=[{
            'stroke_color': '#9E0031',
            'stroke_opacity': 1.0,
