...
def bot():
    ...
    # ------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if l < 250 and l >= 200 and s < 0.25:
            verdict = "Chance of Natural Wildfire Breakout in Your Area"
        else:
            verdict = "Low Chance of Natural Wildfire Breakout in Your Area" 
        ...
        infoboxmap = Map(
            ...
            polygons=[{
                ...
                'stroke_weight': 3,
                'path': c_raw,
                'infobox': 'Calculated Spread of Closest Fire after 2 days'
            },{
                ...
                'stroke_weight': 3,
                'path': s_raw,
                'infobox': 'Calculated Spread of Second Closest Fire after 2 days'
            },{
                ...
                'stroke_weight': 3,
                'path': t_raw,
                'infobox': 'Calculated Spread of Third Closest Fire after 2 days'
            }],
            circles=[{
                'stroke_color': '#9E0031',
                'stroke_opacity': 1.0,
